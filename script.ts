...
//
const good_answer_display_two: HTMLElement | null = document.getElementById('idk_why')
...
function handle_user_next_for_good2(): void {
    if (quizz2_display !== null && good_answer_display_two !== null && wrong_answer_display_two !== null){
        good_answer_display_two.classList.add('no_display')
        quizz2_display.classList.remove('no_display')
    }
}
